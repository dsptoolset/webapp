...
import { selectionModeEnum } from "./types";
import { NodeConfigurePopup } from './NodeConfigPopup';
  ...
  return (
    <>
      ...
      <div
        ...
        className={`${node.style} flex items-center justify-center justify-center select-none cursor-pointer`}
      >
        {node.displayName === 'sigma'
